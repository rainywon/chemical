...
class Config:
    ...
    def __init__(self, data_dir: str = r"C:\wu\RAG\data"):
        ...
        self.embedding_model_path = r"C:\Users\coinrainy\Desktop\毕设数据\models\bge-large-zh-v1.5"  # 文本嵌入模型存储路径
        self.vector_db_path = "vector_store/data"  # FAISS向量数据库存储目录
        self.rerank_model_path = r"C:\Users\coinrainy\Desktop\毕设数据\models\bge-reranker-large"  # 重排序模型路径
